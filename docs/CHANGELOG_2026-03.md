...
- Adjusted default port from `18791` to `19000` to avoid conflicts with OpenClaw Browser Control port
- Synchronously updated default addresses for `office-agent-push.py`, `healthcheck.sh`, `scripts/smoke_test.py`
- Synchronously updated Tauri / Electron desktop shell default connection address
- Synchronously updated local access and tunnel examples in README / SKILL / join-office documentation
